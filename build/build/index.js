...
// build/library/Sample/DefaultComponent.js
var DefaultComponent = function DefaultComponent2(_ref) {
  ...
  }, "IFLEX-REACT-LIBRARY"), /* @__PURE__ */ react.createElement("h3", {
    style: {
      color: "darkorange"
    }
  }, "This text is from the default Component"), children);
};
...
// build/library/Sample/logo.svg.proxy.js
var logo_svg_proxy_default = "/build/library/Sample/logo.svg";

// build/library/Sample/bootflex110.png.proxy.js
var bootflex110_png_proxy_default = "/build/library/Sample/bootflex110.png";

// build/library/Sample/About.js
...
var About = function About2(_ref) {
  var showCounter = _ref.showCounter, showReactLogo = _ref.showReactLogo, showBootflexLogo = _ref.showBootflexLogo;
  var _useState = useState(0), _useState2 = _slicedToArray(_useState, 2), count = _useState2[0], setCount = _useState2[1];
  useEffect(function() {
  ...
  return /* @__PURE__ */ react.createElement("div", {
    ...
    className: "test-component-primary"
  }, showReactLogo ? /* @__PURE__ */ react.createElement("img", {
    src: logo_svg_proxy_default,
    className: "test-component-logo",
    alt: "logo"
  }) : /* @__PURE__ */ react.createElement(react.Fragment, null), /* @__PURE__ */ react.createElement("h1", {
    className: "test-component-heading"
  }, "iflex-react-library"), showCounter ? /* @__PURE__ */ react.createElement("h3", {
    className: "test-component-counter"
  }, "Page has been open for ", /* @__PURE__ */ react.createElement("code", null, count), " seconds.") : /* @__PURE__ */ react.createElement(react.Fragment, null), /* @__PURE__ */ react.createElement("p", {
    className: "test-component-text"
  }, "X-This component demonstrates a library component using Hooks, Images and scss inside a library module file. If you install this library into an external app via npm these images and hooks will not created an error. Try modifying any of the sample components and see how state is preserved (time counter is not reset to zero) when changes are made."), showBootflexLogo ? /* @__PURE__ */ react.createElement("img", {
    src: bootflex110_png_proxy_default,
    alt: "bootflexlogo"
  }) : /* @__PURE__ */ react.createElement(react.Fragment, null)));
};
About.propTypes = {
  showCounter: prop_types_default.bool,
  showReactLogo: prop_types_default.bool,
  showBootflexLogo: prop_types_default.bool
};
About.defaultProps = {
  showCounter: true,
  showReactLogo: true,
...
// build/library/Sample/Button.js
function _extends() {
...
var Button = function Button2(_ref) {
  var color = _ref.color, size = _ref.size, label = _ref.label, onClick = _ref.onClick, props = _objectWithoutProperties(_ref, ["color", "size", "label", "onClick"]);
  var style = {
    color: "white"
  };
  if (color)
  ...
  return /* @__PURE__ */ react.createElement("button", _extends({
    type: "button",
    className: "storybook-button storybook-button-".concat(size),
    style,
    onClick
  }, props), label);
};
Button.propTypes = {
  color: prop_types_default.oneOf(["blue", "red", "green", "purple"]),
...
// build/library/Sample/Layout.js
var Layout = function Layout2(_ref) {
  var header = _ref.header, sidebar = _ref.sidebar, content = _ref.content, footer = _ref.footer;
  return /* @__PURE__ */ react.createElement("div", {
    className: "wrapper"
  }, header ? /* @__PURE__ */ react.createElement("div", {
    className: "box header"
  }, header) : /* @__PURE__ */ react.createElement(react.Fragment, null), sidebar ? /* @__PURE__ */ react.createElement("div", {
    className: "box sidebar"
  }, sidebar) : /* @__PURE__ */ react.createElement(react.Fragment, null), content ? /* @__PURE__ */ react.createElement("div", {
    className: "box content"
  }, content) : /* @__PURE__ */ react.createElement(react.Fragment, null), footer ? /* @__PURE__ */ react.createElement("div", {
    className: "box footer"
  }, footer) : /* @__PURE__ */ react.createElement(react.Fragment, null));
};
Layout.propTypes = {
  header: prop_types_default.string,
  content: prop_types_default.oneOfType([prop_types_default.string, prop_types_default.element]),
  footer: prop_types_default.oneOfType([prop_types_default.string, prop_types_default.element]),
  sidebar: prop_types_default.oneOfType([prop_types_default.string, prop_types_default.element])
};
Layout.defaultProps = {
  header: "HEADER",
...
// build/library/index.js
var library_default = DefaultComponent_default;

// build/demo/App.js
var App = function App2() {
  return /* @__PURE__ */ react.createElement(library_default, null, /* @__PURE__ */ react.createElement(About_default, null));
};
var App_default = App;
